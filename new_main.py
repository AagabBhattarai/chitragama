...
def main():
    ...
    for _ in range(metainfo.total_views - 2):
        ...
        for processed_frame in views_processed:
            triangulate_new_points(Views, Scene_graph, (processed_frame, viewid), object_points)
...
def find_new_viewid(Views, views_processed, object_points:ObjectPoints, feature_track):
    ...
    finished = True if frame_n == -1 else False
    print("New Frame:", frame_n)
    return finished, frame_n 
