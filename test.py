...
if __name__ == "__main__":
    ...
    main()
# import open3d as o3d
# import open3d.geometry as o3dgeom
# import numpy as np
# o3dapp = o3d.visualization.gui.Application.instance
...
# # Open3d visualizer animation callback function
# # def rotate_around(vger):
# #     R = pcd.get_rotation_matrix_from_xyz((0, np.deg2rad(2), 0))
# #     pcd.rotate(R, center=(0,0,0))
# #     pcd.translate((0,0.001,0))
# #     vger.update_geometry(pcd)
# #     vger.update_renderer()

# o3dapp.initialize()
# dawin = o3dapp.create_window("Da Wind", 500, 500)
# dabut = o3d.visualization.gui.Button("Da Butt")
# dawin.add_child(dabut)
# #o3dapp.run()
# #vis = o3d.visualization.Visualizer()
# #vis = o3d.visualization.VisualizerWithKeyCallback()
# #vis.create_window(window_name = 'Fuck You Python', width = 500, height = 500)
# #faew = vis.window
# # vis.add_geometry(pcd)

# # vis.register_animation_callback(rotate_around)
# # vis.register_key_callback(65, rotate_around)

# # opts = vis.get_render_option()
# # opts.show_coordinate_frame = True
# # opts.background_color = np.asarray([0.7, 0.7, 0.7])
